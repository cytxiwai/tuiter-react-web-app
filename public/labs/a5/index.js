...
let sortaTrue = '1' == 1
let notTrue   = '1' === 1
console.log({true1, false1, false2, true2, true3, true4, true5, false3, sortaTrue, notTrue});
...
console.log({length1, index1});

console.log('Add and remove data to arrays');
// push() adding new items to the end of array
numberArray1.push(6);
stringArray1.push('string3');
// slice(start_index, how many element change) - remove 1 item starting on index 2 (the third element of array)
